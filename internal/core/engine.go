...
// SpacerSlots reports, per side, which slots are spacer modules (gap). The
// layout uses this to donate a spacer's edge cells to adjacent modules.
// Indexing matches SlotCounts / the snapshot tables.
